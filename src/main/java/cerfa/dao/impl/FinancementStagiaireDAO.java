...
public class FinancementStagiaireDAO extends DAO<FinancementStagiaire> implements IFinancementStagiaireDAO {

	public FinancementStagiaireDAO() throws ClassNotFoundException, DbException {
		super();
